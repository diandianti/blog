...
tags: linux
categories: 总结
excerpt: 我大概是从研究生的时候就开始使用linux，并将其作为主力系统。本文中是我自己在使用linux过程中，使用起来比较趁手的软件。
---
...
- 一张截图
- ![ranger](https://github.com/diandianti/linux_collection/raw/main/pics/ranger.png)
...
![i3](https://github.com/diandianti/linux_collection/raw/main/pics/i3.png)
